...
public class CotrollerTest {
	...
	public void homeTest() throws Exception {
		...
		/*
			MockMvc : 테스트를 진행하기 위한 생성한 Spring MVC
			perform(requestBuilder) : mockMvc에 요청을 보내는 메서드
			RequestBuilders : 원하는 메서드의 RequestBuilder를 생성하는 팩토리 클래스
			andReturn() : perform()을 통해 실행된 컨트롤러의 결과를 꺼낸다 
						  해당 컨트롤러 실행 결과에서 원하는 값들에 접근할 수 있다 
		*/
		
		String resultPage = mockMvc.perform(
						MockMvcRequestBuilders.get("/nomal/home")
